...
export function WorkflowStepsStatisticsFilter() {
  ...
  // includeSubUnits is true by default, so only count it as active if it's false (user changed it)
  const hasActiveFilters = unitId || startDate || endDate || includeSubUnits === false;
