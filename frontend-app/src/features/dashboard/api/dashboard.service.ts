...
export const dashboardService = {
  ...
  async getDashboardOverview(query?: DashboardQuery) {
    try {
      ...
      return (
        (response.data as IResponse<CorrespondenceDashboardSummary>) || null
      );
    } catch (error) {
  ...
  async getCorrespondenceMetrics(query?: CorrespondenceMetricsQuery) {
    try {
      ...
      return (
        (response.data as IResponse<CorrespondenceMetricsViewModel>) || null
      );
    } catch (error) {
  ...
  async getPerformanceAnalytics(query?: PerformanceAnalyticsQuery) {
    try {
      ...
      return (
        (response.data as IResponse<PerformanceAnalyticsViewModel>) || null
      );
    } catch (error) {
  ...
  async getTypeDistribution(query?: DashboardQuery) {
    try {
      ...
      return (
        (response.data as IResponse<CorrespondenceTypeDistribution[]>) || null
      );
    } catch (error) {
  ...
  async getStatusDistribution(query?: DashboardQuery) {
    try {
      ...
      return (
        (response.data as IResponse<CorrespondenceStatusDistribution[]>) || null
      );
    } catch (error) {
  ...
  async getDailyPerformanceSummary(query?: DailyPerformanceQuery) {
    try {
      ...
      return (
        (response.data as IResponse<DailyPerformanceSummaryViewModel>) || null
      );
    } catch (error) {
