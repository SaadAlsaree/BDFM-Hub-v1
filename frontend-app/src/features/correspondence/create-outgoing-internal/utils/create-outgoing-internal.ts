...
export type OutgoingInternalSchema = z.infer<
  typeof createOutgoingInternalSchema
>;
export type UpdateOutgoingInternalSchema = z.infer<
  typeof updateOutgoingInternalSchema
>;
