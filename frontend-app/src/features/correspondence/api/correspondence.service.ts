...
import { CorrespondenceLinkPayload, ExternalCorrespondencePayload, InboxList, IncomingInternalMailPayload, OutgoingInternalMailPayload, UpdateCorrespondenceStatusPayload } from '../types/register-incoming-external-mail';
import { CorrespondenceDetails, WorkflowStepTodoPayload, WorkflowStepTodoStatusPayload } from '../inbox-list/types/correspondence-details';
...
export const correspondenceService = {
    ...
    async createOutgoingInternalMail(outgoingInternalMailPayload: OutgoingInternalMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreateOutgoingInternalMail`, outgoingInternalMailPayload);
    ...
    async createIncomingInternalMail(incomingInternalMailPayload: IncomingInternalMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreateIncomingInternalMail`, incomingInternalMailPayload);
            if (response.status >= 400) {
                // console.error('Error creating correspondence data:', response.statusText);
                return null;
            }
    ...
    async createCorrespondenceData(correspondenceData: ExternalCorrespondencePayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreateCorrespondenceData`, correspondenceData);
            if (response.status >= 400) {
                // console.error('Error creating correspondence data:', response.statusText);
                return null;
            }
    ...
    async linkCorrespondences(correspondenceLinkPayload: CorrespondenceLinkPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/LinkCorrespondences`, correspondenceLinkPayload);
            if (response.status >= 400) {
    ...
    async updateCorrespondenceContent(correspondenceContent: MailDraftPayload) {
        try {
            const response = await axiosClient.put(`${baseUrl}/Correspondence/UpdateCorrespondenceContent`, correspondenceContent);
            return response.data as IResponse<boolean> || null;
        } catch (error) {
    ...
    async createRegisterIncomingExternalMail(registerIncomingExternalMail: InternalMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/RegisterIncomingExternalMail`, registerIncomingExternalMail);
            if (response.status >= 400) {
    ...
    async createOutgoingExternalMail(outgoingExternalMailPayload: OutgoingExternalMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/RegisterOutgoingExternalMail`, outgoingExternalMailPayload);
    ...
    async searchCorrespondences(searchTerm: string) {
        try {
            const response = await axiosClient.get(`${baseUrl}/Correspondence/SearchCorrespondences?SearchTerm=${searchTerm}`);
    ...
    async getUserInbox(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetUserInbox`, {
                params: query
            });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getOutgoingInternal(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetOutgoingInternal`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getIncomingInternal(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetIncomingInternal`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getCorrespondenceOutgoing(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetCorrespondenceOutgoing`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getCorrespondenceIncming(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetCorrespondenceIncming`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getCorrespondenceById(id: string) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetById?id=${id}`);
    ...
    async getTrashItems(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetTrashItems`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getStarredItems(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetStarredItems`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getUserDrafts(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetUserDrafts`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getPostponedCorrespondences(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetPostponedCorrespondences`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getLateBooks(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetLateBooks`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getUrgentBooks(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetUrgentBooks`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async getPublicMails(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/Correspondence/GetPublicMails`, { params: query });
            return response.data as IResponseList<InboxList>;
        } catch (error) {
    ...
    async createInternalMail(internalMailPayload: InternalMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreateInternalMail`, internalMailPayload);
            return response.data as IResponse<string>;
        } catch (error) {
    ...
    async createMailDraft(mailDraftPayload: MailDraftPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreateMailDraft`, mailDraftPayload);
            return response.data as IResponse<string>;
        } catch (error) {
    ...
    async createPublicCorrespondence(createPublicMailPayload: CreatePublicMailPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/Correspondence/CreatePublicCorrespondence`, createPublicMailPayload);
            return response.data as IResponse<string>;
        } catch (error) {
    ...
    async isInTrash(isInTrash: boolean, correspondenceId: string) {
        ...
        try {
            const response = await axiosClient.post(`${baseUrl}/UserCorrespondenceInteraction/IsInTrash`, payload);
    ...
    async isPostponed(postponeDate: string, correspondenceId: string) {
        ...
        try {
            const response = await axiosClient.post(`${baseUrl}/UserCorrespondenceInteraction/IsPostponed`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async isRead(isRead: boolean, correspondenceId: string) {
        ...
        try {
            const response = await axiosClient.post(`${baseUrl}/UserCorrespondenceInteraction/IsRead`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async isStarred(isStarred: boolean, correspondenceId: string) {
        ...
        try {
            const response = await axiosClient.post(`${baseUrl}/UserCorrespondenceInteraction/IsStarred`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async receiveNotification(receiveNotifications: boolean, correspondenceId: string) {
        const payload = {
            receiveNotifications,
            correspondenceId
        }
        try {
            const response = await axiosClient.post(`${baseUrl}/UserCorrespondenceInteraction/ReceiveNotification`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async changeCorrespondenceStatus(payload: UpdateCorrespondenceStatusPayload) {
        ...
        try {
            const response = await axiosClient.put(`${baseUrl}/Correspondence/ChangeCorrespondenceStatus`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async createWorkflowStepTodo(payload: WorkflowStepTodoPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/WorkflowTodo/CreateWorkflowTodo`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async updateWorkflowStepTodo(payload: WorkflowStepTodoPayload) {
        try {
            const response = await axiosClient.put(`${baseUrl}/WorkflowTodo/UpdateWorkflowTodo`, payload);
            return response.data as IResponse<boolean>;
        } catch (error) {
    ...
    async updateWorkflowStepTodoStatus(payload: WorkflowStepTodoStatusPayload) {
        try {
            const response = await axiosClient.patch(`${baseUrl}/WorkflowTodo/UpdateWorkflowTodoStatus/UpdateStatus`, payload);
            return response.data as IResponse<boolean>;
        }
        catch (error) {
    ...
    async deleteWorkflowStepTodo(workflowStepTodoId: string) {
        try {
            const response = await axiosClient.delete(`${baseUrl}/WorkflowTodo/DeleteWorkflowTodo/${workflowStepTodoId}`);
            return response.data as IResponse<boolean>;
        }
        catch (error) {
    ...
    async getWorkflowStepTodoByWorkflowId(query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/WorkflowTodo/GetWorkflowTodoByWorkflowId`, { params: query });
