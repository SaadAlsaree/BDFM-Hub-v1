...
import { IOrganizationalUnitResponse, IOrganizationalUnitDetails, CreateOrganizationalUnitPayload, IOrganizationalUnitList } from '@/features/organizational-unit/types/organizational';
...
export const organizationalService = {
    async getOrganizationalUnits(query?: Record<string, any>) {
        ...
        try {
            ...
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitList`, { params: query });
    ...
    async getOrganizationalUnitById(id: string) {
        try {
            ...
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitById/${id}`);
    ...
    async createOrganizationalUnit(unit: CreateOrganizationalUnitPayload) {
        try {
            const response = await axiosClient.post(`${baseUrl}/OrganizationalUnit/CreateOrganizationalUnit`, unit);
    ...
    async updateOrganizationalUnit(unit: CreateOrganizationalUnitPayload) {
        try {
            ...
            const response = await axiosClient.put(`${baseUrl}/OrganizationalUnit/UpdateOrganizationalUnit`, unit);
    ...
    async getOrganizationalUnitTree() {
        try {
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitTree/Tree`);
    ...
    async getOrganizationalUnitListById(includeInactive: boolean) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitListById`, { params: { includeInactive } });
    ...
    async getOrganizationalUnitListByIdClient(includeInactive: boolean) {
        try {
            const response = await axiosClient.get(`${baseUrl}/OrganizationalUnit/GetOrganizationalUnitList`, { params: { includeInactive } });
    ...
    async searchOrganizationalUnits(query: Record<string, any>) {
        ...
        try {
            const response = await axiosInstance.get(`${baseUrl}/OrganizationalUnit/Search`, { params: query });
    ...
    async searchOrganizationalUnitsClient(query: Record<string, any>) {
        ...
        try {
            const response = await axiosClient.get(`${baseUrl}/OrganizationalUnit/Search`, { params: query });
