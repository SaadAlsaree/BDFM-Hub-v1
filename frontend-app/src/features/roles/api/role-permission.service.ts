...
export const rolePermissionService = {
    async updateRolePermissions(payload: RolePermissionAssignmentDto) {
        try {
            const response = await axiosClient.post(`${baseUrl}/RolePermission/AssignPermissionsToRole`, payload);
    ...
    async getPermissionsForARoleById(roleId: string, query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/RolePermission/GetPermissionsByRoleId/${roleId}/permissions`, { params: query });
    ...
    async getRolesForAPermissionById(permissionId: string, query: Record<string, any>) {
        try {
            const response = await axiosInstance.get(`${baseUrl}/RolePermission/GetRolesByPermissionId/${permissionId}/roles`, { params: query });
