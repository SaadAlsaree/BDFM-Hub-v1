...
export const statusLabels: Record<ExternalEntityStatus, { label: string; variant: "default" | "destructive" | "outline" | "secondary" }> = {
...
export const formatExternalEntityPayload = (formData: ExternalEntityFormValues, id?: string) => {
    const payload = {
        ...formData,
    };
