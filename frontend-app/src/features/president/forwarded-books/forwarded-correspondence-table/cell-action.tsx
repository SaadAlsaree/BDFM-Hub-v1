...
export const CellActionForwardedCorrespondence: React.FC<CellActionProps> = ({
  data
}) => {
  ...
  const onMarkAsRead = async () => {
    ...
    try {
      ...
      toast.success('تم تمييز المراسلة كمقروءة');
    } catch (error) {
      toast.error('حدث خطأ أثناء تمييز المراسلة كمقروءة');
    } finally {
      setLoading(false);
    }
  };
  ...
  const onMoveToTrash = async () => {
    ...
    try {
      ...
      toast.success('تم نقل المراسلة إلى سلة المهملات');
      setOpen(false);
    } catch (error) {
      toast.error('حدث خطأ أثناء نقل المراسلة إلى سلة المهملات');
    } finally {
      setLoading(false);
    }
  };
  ...
  const onArchive = async () => {
    ...
    try {
      ...
      toast.success('تم أرشفة المراسلة');
    } catch (error) {
      toast.error('حدث خطأ أثناء أرشفة المراسلة');
    } finally {
      setLoading(false);
    }
  };
