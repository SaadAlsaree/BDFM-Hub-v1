import { Mail, MailOpen, Star, BellRing } from 'lucide-react';
...
const CellIconsForwardedCorrespondence = ({ data }: CellIconsProps) => {
...
export default CellIconsForwardedCorrespondence;
