...
import { CellActionForwardedCorrespondence } from './cell-action';
import Link from 'next/link';
import { ForwardedCorrespondenceItem } from '@/features/forwarded-correspondence/types/forwarded-correspondence';
import CellIconsForwardedCorrespondence from './cell-icons';

export const columns: ColumnDef<ForwardedCorrespondenceItem>[] = [
  {
    id: 'mailNum',
    accessorKey: 'mailNum',
    header: ({
      ...
      column: Column<ForwardedCorrespondenceItem, unknown>;
      ...
      return (
        <div className='flex flex-col'>
          <div className='flex cursor-pointer items-center gap-2'>
            <CellIconsForwardedCorrespondence data={row.original} />
            <Link
              href={`/president/forwarded-books/${row.original.correspondenceId}`}
  ...
  },
  {
    ...
    cell: ({ row }) => <CellActionForwardedCorrespondence data={row.original} />
  }
];
