...
import { forwardedCorrespondenceService } from '../api/forwarded-correspondence.service';
import { columns } from './forwarded-correspondence-table/columns';
import ForwardedCorrespondenceTable from './forwarded-correspondence-table';

export default async function ForwardedCorrespondenceListing() {
  ...
  return (
    <ForwardedCorrespondenceTable<ForwardedCorrespondenceItem, unknown>
