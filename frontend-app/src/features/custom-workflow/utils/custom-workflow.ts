...
export type CustomWorkflowCreateSchema = z.infer<
  typeof customWorkflowCreateSchema
>;

export const customWorkflowStepCreateSchema = z.object({
  ...baseStep
});
export type CustomWorkflowStepCreateSchema = z.infer<
  typeof customWorkflowStepCreateSchema
>;
...
export type CustomWorkflowUpdateSchema = z.infer<
  typeof customWorkflowUpdateSchema
>;
...
export type CustomWorkflowStepUpdateSchema = z.infer<
  typeof customWorkflowStepUpdateSchema
>;

// Generic validators
export function validateCustomWorkflowCreate(
  payload: unknown
): CustomWorkflowCreateSchema {
  return customWorkflowCreateSchema.parse(payload);
}

export function validateCustomWorkflowUpdate(
  payload: unknown
): CustomWorkflowUpdateSchema {
  return customWorkflowUpdateSchema.parse(payload);
}

export function validateCustomWorkflowStepCreate(
  payload: unknown
): CustomWorkflowStepCreateSchema {
  return customWorkflowStepCreateSchema.parse(payload);
}

export function validateCustomWorkflowStepUpdate(
  payload: unknown
): CustomWorkflowStepUpdateSchema {
