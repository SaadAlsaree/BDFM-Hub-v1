...
export const CorrespondenceTypeDisplayName: Record<
...
export function getCorrespondenceTypeDisplayName(
  value?: CorrespondenceTypeEnum | number | null
): string {
...
export function getActionTypeDisplayName(
  value?: ActionTypeEnum | number | null
): string {
  if (value === null || value === undefined) return '';
...
export const CustomWorkflowTargetTypeDisplayName: Record<
...
export function getCustomWorkflowTargetTypeDisplayName(
  value?: CustomWorkflowTargetTypeEnum | number | null
): string {
  if (value === null || value === undefined) return '';
