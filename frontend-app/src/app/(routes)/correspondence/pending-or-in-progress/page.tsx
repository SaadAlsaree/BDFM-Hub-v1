...
import GetPendingOrInProgressListing from '@/features/correspondence/inbox-list/components/get-pending-or-in-progress-listing';
...
export default async function PendingOrInProgressPage(
  props: PendingOrInProgressPageProps
) {
    ...
    <PageContainer scrollable={false}>
      <div className='flex flex-1 flex-col space-y-4'>
        <div className='flex items-start justify-between'>
          <Heading
            title='الكتب في الانتظار أو قيد التنفيذ'
            description='إدارة الكتب في الانتظار أو قيد التنفيذ'
          />
        </div>
        <Separator />
