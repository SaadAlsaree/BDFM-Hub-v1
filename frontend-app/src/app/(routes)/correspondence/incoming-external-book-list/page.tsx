...
const IncomingExternalPage = async (props: OutgoingCorrespondencePageProps) => {
    ...
    <PageContainer scrollable={false}>
      <div className='flex flex-1 flex-col space-y-4'>
        <div className='flex items-start justify-between'>
          <Heading title='وارد خارجي' description='إدارة الكتب الصادرة' />
          <Link
            href='/correspondence/register-incoming-external-mail'
...
export default IncomingExternalPage;
