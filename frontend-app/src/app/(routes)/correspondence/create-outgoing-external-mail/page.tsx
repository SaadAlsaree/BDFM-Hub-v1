...
import { RegisterOutgoingExternalMailWizard } from '@/features/correspondence/register-outgoing-external-mail';
...
export const metadata = {
  title: 'إضافة كتاب صادر خارجي جديد',
  description: 'إضافة كتاب صادر خارجي جديد'
};

// Force dynamic rendering since we use getServerSession which requires headers
export const dynamic = 'force-dynamic';

const CreateOutgoingExternalMail = async () => {
...
export default CreateOutgoingExternalMail;
